class ArticlesController < ApplicationController
    def index
        ...
        respond_to do |format|
            format.html
            format.json{ render json:{articles: @articles.as_json(only: [:id, :title]), current_user: current_user}, layout: false}
        end
      end
    ...
    def create
        ...
        if @article.save
            respond_to do |format|
                ...
                format.json { render json: {article_id: @article.as_json(only: [:id])}, layout: false }
            end
        else
            respond_to do |format|
