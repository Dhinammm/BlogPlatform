...
function Articles() {
  ...
  // useEffect(() => {
  function fetchdata() {
    fetch("http://localhost:3000/articles").then(function (data) {
  ...
  }, "Articles List"), fetchdata, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
...
/******/ });
//# sourceMappingURL=Articles-cf44d841b37d4dc2766e.js.map