...
function ArticleEdit() {
  ...
  function updatehandler() {
    ...
    fetch("/articles/".concat(id, "/update"), {
      method: "PUT",
      headers: {
      ...
      if (response.ok) {
        ...
        window.location.href = "/articles/".concat(id); // Redirect to updated article
      } else {
...
/******/ });
//# sourceMappingURL=ArticleEdit-c57f8217bc6e9dfcc2e4.js.map